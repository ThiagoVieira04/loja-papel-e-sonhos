            ...
            >
              <div className="relative aspect-square max-w-md mx-auto">
                ...
                <div className="absolute inset-4 rounded-[2rem] border border-white/10 bg-white/5 backdrop-blur-md flex flex-col items-center justify-center gap-4 text-center p-8 overflow-hidden">
                  ...
                  <div className="relative w-36 h-36 rounded-full bg-gradient-to-br from-primary/25 via-secondary/15 to-transparent ring-1 ring-white/25 shadow-[0_0_50px_rgba(209,30,90,0.35)] flex items-center justify-center animate-float">
                    <img
                      src="/logo.png"
                      alt="Papel e Sonhos"
                      className="w-28 h-28 object-contain drop-shadow-[0_0_18px_rgba(209,30,90,0.55)]"
                    />
                  </div>
